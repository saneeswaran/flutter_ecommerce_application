...
class WomenShopping extends StatefulWidget {
  const WomenShopping({super.key});

  @override
  State<WomenShopping> createState() => _WomenShoppingState();
}

class _WomenShoppingState extends State<WomenShopping> {
